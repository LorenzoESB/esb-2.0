/**
 * Test script to verify renda fixa calculations
 * Run with: pnpm exec ts-node src/simuladores/renda-fixa/test-calculations.ts
 */

import Decimal from 'decimal.js';
import { calcularInvestimentosRendaFixa } from './calc/renda-fixa.calc';
...
// Run calculations
const resultado = calcularInvestimentosRendaFixa(
  investimento,
  prazoMeses,
  selicAnual,
  cdiAnual,
...
// Compare with expected legacy values
console.log('='.repeat(80));
