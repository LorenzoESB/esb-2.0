...
exports.TollPassScoreCalculator = void 0;
const criteria_data_1 = require("../data/criteria.data");
class TollPassScoreCalculator {
    static rank(items) {
    ...
    static calculate(item) {
        let totalWeight = 0;
        let weightedScore = 0;
        const breakdown = criteria_data_1.TOLL_PASS_CRITERIA.map((criterion) => {
...
exports.TollPassScoreCalculator = TollPassScoreCalculator;
